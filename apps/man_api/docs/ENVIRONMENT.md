...
| ------------- | ----------------------- | ----------- |
| ERLANG_COOKIE | `vmUAodc/`.. | Erlang [distribution cookie](http://erlang.org/doc/reference_manual/distributed.html). **Make sure that default value is changed in production.** |
...
| SECRET_KEY    | `vmUAodc/`..  | Phoenix [`:secret_key_base`](https://hexdocs.pm/phoenix/Phoenix.Endpoint.html). **Make sure that default value is changed in production.** |
